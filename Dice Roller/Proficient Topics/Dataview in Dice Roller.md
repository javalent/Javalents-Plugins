...
publish: true
tags: [Dice-Roller/Proficient/Dataview]
---
...
> ![400](_images/Dataview%20in%20Dice%20Roller_image_1.png)
...
You would need to integrate the [[Dice Roller/Proficient Topics/Dice Roller and Javascript|dice roller api]] into a `dataviewjs` [code block](Glossary/Code%20Block.md) to attempt to make a `dv.table`.