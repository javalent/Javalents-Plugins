...
3D Dice can be rolled using the Dice View if [[Dice Roller Settings#Always Render Dice|Always Render Dice]] is turned on in settings, or the [[Dice Flags#Render and NoRender|Render and NoRender]] flag is used in the dice formula.
