...
> ![400](_images/IMG-20230804-18.png)
...
You would need to integrate the [[Dice Roller/Dice Roller and Javascript|dice roller api]] into a `dataviewjs` [code block](Glossary/Code%20Block.md) to attempt to make a `dv.table`.